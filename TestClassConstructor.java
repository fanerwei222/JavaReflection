...
public class TestClassConstructor
{
    ...
    public static void testGetDeclaredConstructor()
    {
        ...
        {
            // 获取Person类的Class
            Class<?> cls = Class.forName("main.reflection.Person");

            // 根据class，获取构造函数
            Constructor cst1 = cls.getDeclaredConstructor();
            Constructor cst2 = cls.getDeclaredConstructor(new Class[]
            { String.class });
            Constructor cst3 = cls.getDeclaredConstructor(new Class[]
            { String.class, int.class, Gender.class });
    ...
    public static void testGetConstructor()
    {
        try
        {
            ...
            Constructor cst3 = cls.getConstructor(new Class[]
            { String.class, int.class, Gender.class });
    ...
    public static void testGetEnclosingConstructor()
    {
        try
        {
            ...
            Constructor cst = cls.getDeclaredConstructor(new Class[]
