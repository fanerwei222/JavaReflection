 ...
 *
 */
public class TestClassOtherAPIs
{
    public static void main(String[] args)
    {

        Class cls = TestClassOtherAPIs.class;
        // 获取“类名”
    ...
    public static void testOtherAPIs()
    {
        ...
        // 判断是不是类的对象
        Class demoCls = TestClassOtherAPIs.class;
        TestClassOtherAPIs demoObj = new TestClassOtherAPIs();
        ...
        Class synCls = TestClassOtherAPIs.class;
